...
const queryPermissionsByUser = (params)=>getAction("/sys/permission/getUserPermissionByToken",params);  // 登陆获取菜单信息
const queryPermissionsByUserTwo = (params)=>getAction("/sys/permission/getUserPermissionByTokenTwo",params);
...
const uorganization = (params)=>getAction("/api/uc/organizations",params)
